...
The API is documented in Swagger: [Swagger UI link](http://localhost:8080/swagger-ui/index.html?urls.primaryName=springdocDefault)
...
To build the final jar and optimize the libraary application for production, run:
